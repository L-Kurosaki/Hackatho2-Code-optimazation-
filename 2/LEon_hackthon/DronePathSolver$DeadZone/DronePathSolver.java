        ...
        while (runs.size() < maxRuns && visitedEnclosures.size() < enclosures.size()) {
            ...
            if (bestFood != null) {
                ...
                for (Enclosure e : sortedEnclosures) {
                    ...
                    int back = distance(e.x, e.y, depotX, depotY) + landingCost(depotZ);
                    if (toEnc + back > remainingBattery) continue;
